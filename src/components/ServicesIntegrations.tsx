...
<div className="mt-5">
  <div className="inline-flex h-[42px] rounded-[16px] bg-accent-1 p-[2px]">
    <div className="flex h-full rounded-[14px] bg-accent-1 p-[2px]">
      <button
        type="button"
        onClick={() => setMode("services")}
        className={
          mode === "services"
            ? "inline-flex h-full items-center justify-center rounded-[12px] bg-accent-3 px-4 text-[13px] font-semibold leading-none text-text"
            : "inline-flex h-full items-center justify-center rounded-[12px] px-4 text-[13px] font-semibold leading-none text-bg/90"
        }
        aria-pressed={mode === "services"}
      >
        <span className="inline-flex h-full items-center justify-center gap-2">
          <Layers className="h-[12px] w-[12px] shrink-0" />
      ...
      <button
        ...
        className={
          mode === "process"
            ? "inline-flex h-full items-center justify-center rounded-[12px] bg-accent-3 px-4 text-[13px] font-semibold leading-none text-text"
            : "inline-flex h-full items-center justify-center rounded-[12px] px-4 text-[13px] font-semibold leading-none text-bg/75"
        }
        aria-pressed={mode === "process"}
      >
        <span className="inline-flex h-full items-center justify-center gap-2">
          <Workflow className="h-[12px] w-[12px] shrink-0" />
